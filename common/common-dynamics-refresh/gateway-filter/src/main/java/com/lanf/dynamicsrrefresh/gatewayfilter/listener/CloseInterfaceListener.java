...
@Component
@Slf4j
public class CloseInterfaceListener implements NacosListener {


    @Override
    public String getDataId() {
        return BizCodeEnum.CLOSE_INTERFACE.getDateId();
    }

    @Override
    public String getGroup() {
        return BizCodeEnum.CLOSE_INTERFACE.getGroup();
    }

    @Override
    public EventHandle getEventHandle() {

        return BeanUtil.getBean(CloseInterfaceHandle.class);
    }
}
